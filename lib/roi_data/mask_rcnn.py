...
def add_mask_rcnn_blobs(blobs, sampled_boxes, roidb, im_scale, batch_idx):
    ...
    if fg_inds.shape[0] > 0:
        ...
        masks = blob_utils.zeros((fg_inds.shape[0], M**2), int32=True)   # 为每个sample的前景roi都准备一个mask
        ...
        fg_polys_inds = np.argmax(overlaps_bbfg_bbpolys, axis=1)      # 每一个前景roi对应的overlap最大的poly box
